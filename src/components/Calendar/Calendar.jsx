            ...
            <S.CalendarWrapper>
                ...
                <S.CalendarBlock>
                    ...
                    <S.CalendarContent>
                        ...
                        <S.CalendarCells>
                            <S.CalendarCell className="_other-month">28</S.CalendarCell>
                            <S.CalendarCell className="_other-month">29</S.CalendarCell>
                            <S.CalendarCell className="_other-month">30</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">31</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">1</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">2</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">3</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">4</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">5</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">6</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">7</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _current">8</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend _active-day">9</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">10</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">11</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">12</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">13</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">14</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">15</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">16</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">17</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">18</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">19</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">20</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">21</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">22</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">23</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">24</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">25</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">26</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">27</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">28</S.CalendarCell>
                            <S.CalendarCell className="_cell-day">29</S.CalendarCell>
                            <S.CalendarCell className="_cell-day _weekend">30</S.CalendarCell>
                            <S.CalendarCell className="_other-month _weekend">1</S.CalendarCell>
                        </S.CalendarCells>
                    </S.CalendarContent>
                    
                    <input type="hidden" id="datepick_value" value="08.09.2023"/>
                    <S.CalendarPeriod>
                        <S.CalendarParagraph className="date-end">
